...
public class CategoryFlatBasketFermentation implements IRecipeCategory<IRecipeWrapper>
{

	protected final IDrawable background;
	protected final IDrawableAnimated progressBar;

	public CategoryFlatBasketFermentation(IGuiHelper helper)
	{
	...
	{
		return "hikethecountryside.flat_basket.fermentation";
	}

	@Override
	public String getTitle()
	{
		return I18n.format("jei.hikethecountryside.category.flat_basket.fermentation");
	}
	...
	public void setRecipe(IRecipeLayout recipeLayout, IRecipeWrapper recipeWrapper)
	{
		...
		items.set(0, ((RecipeFlatBasketFermentation) recipeWrapper).getInputs());
		items.init(1, false, 56, 2);
		items.set(1, ((RecipeFlatBasketFermentation) recipeWrapper).getOutputs());
	}
