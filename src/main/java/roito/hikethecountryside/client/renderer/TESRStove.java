...
public class TESRStove extends TileEntitySpecialRenderer<TileEntityStove>
{
	@Override
	public void render(TileEntityStove tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
	{
